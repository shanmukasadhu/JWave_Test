...
- CONTINUOUS plane wave propagating from left to right
...
print("="*70)
print("3D DESIGN SPACE vs FOCUS SPACE CONFIGURATION")
print("="*70)
...
for i, config in enumerate(configurations):
    ...
    class TimeVaryingSource:
        def __init__(self, time_axis, domain):
            ...
            # Create source mask (left edge region in 3D)
            source_mask = jnp.zeros(N)
            source_mask = source_mask.at[:20, :, :].set(1.0)  # 3D region at left
...
import os
os.makedirs('../Results/continuous_wave_split_3d', exist_ok=True)
...
for i, result in enumerate(results):
    ...
    output_path = f'../Results/continuous_wave_split_3d/config_{i+1}_3d_analysis.png'
...
video_path_3d = f'../Results/continuous_wave_split_3d/config_1_3d_full_volume_animation.mp4'
...
try:
    ...
    video_path_iso = f'../Results/continuous_wave_split_3d/config_1_3d_isosurface_animation.mp4'
...
video_path = f'../Results/continuous_wave_split_3d/config_1_3d_animation_xy_slice.mp4'
...
print("="*70)
print("Results saved to: ../Results/continuous_wave_split_3d/")
print("="*70)
print("\nDone!")
