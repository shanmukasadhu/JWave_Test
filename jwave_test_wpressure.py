...
def create_medium_with_cylinders(domain, cylinder_positions, cylinder_radius=10):
    """
    Create a heterogeneous medium with cylinders
    
    Parameters:
    - domain: jwave Domain object
    - cylinder_positions: list of (x, y) positions for cylinder centers
    - cylinder_radius: radius of cylinders in grid points
    """
    ...
    for pos in cylinder_positions:
        mask = create_cylinder_mask(N, pos, cylinder_radius)
...
# Define 5 different cylinder configurations
# Positions adjusted for larger grid (512x512) and centered in viewing window
# Viewing window is [128:384, 128:384], so center is around (256, 256)
configurations = [
    # Configuration 1: Horizontal line
    [(200, 200), (200, 256), (200, 312)],
    
    # Configuration 2: Vertical line
    [(200, 256), (240, 256), (280, 256)],
    
    # Configuration 3: Diagonal
    [(200, 200), (240, 256), (280, 312)],
    
    # Configuration 4: Triangle
    [(210, 256), (260, 220), (260, 292)],
    
    # Configuration 5: Scattered
    [(210, 220), (260, 280), (230, 310)]
]
...
for i, config in enumerate(configurations):
    ...
    medium = create_medium_with_cylinders(domain, config, cylinder_radius=12)
